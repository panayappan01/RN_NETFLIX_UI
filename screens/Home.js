...
import { SIZES, dummyData, COLORS, icons, images, FONTS } from "../constants";
...
const Home = ({ navigation }) => {
  ...
  function renderDots() {
    ...
    console.log("newSeasonScrollX ", newSeasonScrollX);
    ...
    return (
      ...
      >
        {dummyData.newSeason.map((item, index) => {
          console.log("DOT POSITION ", index, " ", dotPosition);
              ...
              >
                ...
                >
                  ...
                  <ProgressBar
                    ...
                    barPercentage={parseInt(item.overallProgress)}
                  />
                </View>
              </TouchableWithoutFeedback>
            );
